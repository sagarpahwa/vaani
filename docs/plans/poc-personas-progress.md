...
| P5.3 | `make poc-api-test` fully green (incl. new persona golden) | DONE | `pending` | `make poc-api-test` → **195 passed, 2 deselected, 93.82% coverage** (gate 70%); persona golden suite included |
